          ...
          {products.slice(1, 4).map((item, index) => (
            ...
            >
              <div className="flex items-start gap-6 text-sm">
                ...
                <div>
                  ...
                  <p className="mt-2 text-sm font-normal text-navbar-text">
                    Date :{" "}
                    <span className="text-slate-500">25, August 2024</span>
                  </p>
                </div>
              </div>
              ...
              <div className="md:w-1/2 flex justify-between">
                ...
                <button className="btn bg-tranparent  rounded-none text-black border- text-sm font-medium hover:bg-black hover:text-white transition ease-in-out">
                  Track Order
                </button>
              </div>
            </div>
